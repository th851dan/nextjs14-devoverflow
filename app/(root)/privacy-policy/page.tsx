...
export const metadata: Metadata = {
  title: "Privacy Policy — BuddyKnows",
};
        ...
        <div className="text-dark100_light900">
          ...
          <div className="toc mb-6">
            ...
            <ol className="list-decimal ml-6 mt-4">
              ...
              <li>
                <a href="#types-of-data-collected" className="text-primary-500">
              ...
              <li>
                <a href="#links-to-other-websites" className="text-primary-500">
              ...
              <li>
                <a href="#contact-us" className="text-primary-500">
                  Contact Us
                </a>
              </li>
            </ol>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li className="mb-2">
              <strong>Website</strong> refers to BuddyKnows, accessible from{" "}
              <a
                href="https://beta.buddyknows.org"
                className="text-primary-500"
              >
                https://beta.buddyknows.org
              </a>
              .
            </li>
            <li className="mb-2">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-2">
              By email:{" "}
              <a
                href="mailto:support@buddyknows.com"
                className="text-primary-500"
              >
                support@buddyknows.com
              </a>
            </li>
          </ul>
        </div>
