      ...
      <section className="mt-10 flex w-full flex-col gap-4">
        <div className="text-dark100_light900">
          ...
          <p className="mb-4">
            ...
            <a href="https://beta.buddyknows.org" className="text-primary-500">
              beta.buddyknows.org
            </a>{" "}
            ...
            operator (“Operator”, “we”, “us” or “our”). If you are entering into
          ...
          <div className="toc mb-6">
            ...
            <ol className="list-decimal ml-6 mt-4">
              ...
              <li>
                <a href="#user-content" className="text-primary-500">
                  User Content
                </a>
              </li>
              <li>
                <a href="#backups" className="text-primary-500">
                  Backups
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#prohibited-uses" className="text-primary-500">
                  Prohibited Uses
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#indemnification" className="text-primary-500">
                  Indemnification
                </a>
              </li>
              <li>
                <a href="#severability" className="text-primary-500">
                  Severability
                </a>
              </li>
              <li>
                <a href="#dispute-resolution" className="text-primary-500">
                  Dispute Resolution
                </a>
              </li>
              <li>
                <a href="#changes-and-amendments" className="text-primary-500">
              ...
              <li>
                <a href="#contacting-us" className="text-primary-500">
                  Contacting Us
                </a>
              </li>
            </ol>
          ...
          <p className="mb-4">
            <a
              href="&#109;&#097;&#105;&#108;&#116;&#111;&#058;s&#117;&#112;p&#111;rt&#64;bu&#100;d&#121;k&#110;o&#119;&#115;&#46;or&#103;"
              className="text-primary-500"
            >
